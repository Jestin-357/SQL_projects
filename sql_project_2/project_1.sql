...
Get all projects that started in 2021.

Find employees not assigned to any project.

Show employees working in both "Website Redesign" and "Payroll System".

Find total salary cost for each project.

List all employees with their role in each project.
...
Find employees hired the earliest in each department.
